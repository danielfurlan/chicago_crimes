    ...
    children=[
        ...
        children=[
            ...
            children=[
                ...
                html.Button('Got It!', id='beats_button',style={'width':'10px','height':'30px','border':0,'padding':0,}
                            ),
                ]
            ),
        ...
        html.Div(id='hid',style={'display':'hidden'}),
        html.Div(
            id = "contacts",
            children = [
                html.A(
                        html.Img(id = "gitimg",src="./assets/github.png"),
                        href="https://github.com/danielfurlan/chicago_crimes", target='_blank'
                        ),
                html.A(
                        html.Img(id = "linkimg",src="./assets/linkedin2.png"),
...
if first_entry:
    ...
    def update_style(click):
        ...
        if click is None:
            ...
            first_entry = False
            return {'display':'none'}#,["2"]#,{'display':'none'}
...
def get_boundary_map(clickData,sele):
    #global selections
    #sel = selections
    #if first_entry:
        #return ["2"]
    if clickData is None and sele is None:
        #print("We prevent update")
        return ["2"]
        #raise PreventUpdate
    sel = set()
    #print("Our sel from signal", sele)
    if sele is not None:
        sel = set(sele)
    #print("Our sel after setting : ",sel)
    ...
    #if sele is None and first_entry==False:
        #sel = []
        #return sel
...
if __name__ == '__main__':
    app.run_server(debug=True,threaded=True,processes=1)#,port=10450)
    cache.clear()
